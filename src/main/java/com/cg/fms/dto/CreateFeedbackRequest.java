...
private Employee participant;
	...
	public CreateFeedbackRequest(Employee participant, Program program, int feedbackCriteria1, int feedbackCriteria2,
	...
	public String toString() {
		return "CreateFeedbackRequest [participant=" + participant + ", program=" + program + ", feedbackCriteria1="
